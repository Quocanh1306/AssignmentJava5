                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="/thongke" class="nav-item nav-link">Thong ke</a>
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a href="login.jsp" class="dropdown-item active">Login & Register</a>
                            ...
                            <div class="register-form">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" type="text" name="password2" placeholder="Password">
                                    </div>
                                    <div class="col-md-12">
