                    ...
                    <div class="col-md-9">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="address-tab" role="tabpanel" aria-labelledby="address-nav">
                                ...
                                <form action="/account/update/${u.userName}" method="post">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input class="form-control" type="password" name="password" placeholder="Current Password">
                                        </div>
                                        <div class="col-md-6">
                                            <input class="form-control" type="text" name="password1" placeholder="New Password">
                                        </div>
                                        <div class="col-md-6">
