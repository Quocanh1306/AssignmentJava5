        ...
        <div class="cart-page">
            <div class="container-fluid">
                <div class="row">
                                    ...
                                    <c:if test="${not cart.isEmpty()}">
                                        <c:forEach items="${cart}" var="sp">
                                            <tr>
                                                <td>
                                                    <div class="img">
                                                        <a href="#"><img src="${sp.anh}" alt="Image"></a>
                                                        <p>${sp.ten}</p>
                                                    </div>
                                                </td>
                                                <td>${sp.donGia}</td>
                                                <td>
                                                    <div class="qty">
                                                        <button class="btn-minus"><a href="/gio-hang/delete1/${sp.maSanPham}"><i class="fa fa-minus"></i></a></button>
                                                        <input type="text" name="${soLuong}" value="${sp.soLuong}">
                                                        <button class="btn-plus" onclick=""><a href="/gio-hang/add1/${sp.maSanPham}"><i class="fa fa-plus"></i></a></button>
                                                    </div>
                                                </td>
                                                <td>${sp.donGia * sp.soLuong}</td>
                                                <td><button><a href="/gio-hang/delete/${sp.maSanPham}"><i class="fa fa-trash"></i></a></button></td>
                                            </tr>
                                        </c:forEach>
                                    </c:if>
                                    </tbody>
                    ...
                    <div class="col-lg-4">
                        <form action="/hoa-don/pay" method="post">
                            <div class="cart-page-inner">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="coupon">
                                    ...
                                    <div class="col-md-12">
                                        <div class="cart-summary">
                                            <div class="cart-content">
                                                <h1>Cart Summary</h1>
                                                <p>Sub Total<span>${tongTien}</span></p>
                                            </div>
                                            <div class="cart-btn">
