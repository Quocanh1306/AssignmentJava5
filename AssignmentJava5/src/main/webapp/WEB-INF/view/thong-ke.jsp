...
<%--    <c:set var="tenDienThoai" value="${tenDienThoai}${element[0]}"/>--%>
...
<div class="row">
    ...
    <h3>Top San Pham Ton</h3>
    <table class="table">
        <thead>
        <tr>
            <th scope="col">Ten may dien thoai</th>
            <th scope="col">So luong ton</th>
        </tr>
        </thead>
        <tbody>
        <c:forEach items="${listTon}" var="o">
            <tr>
                <td>${o.tenDienThoai}</td>
                <td>${o.soLuong}</td>
            </tr>
        </c:forEach>
        </tbody>
