                    ...
                    <div class="col-md-6">
                        <div class="header-slider normal-slider">
                            <div class="header-slider-item">
                                <img src="https://clickbuy.com.vn/uploads/2023/05/slide-sieu-bao-khuyen-mai-01.png" width="800px" alt="Slider Image" />
                            ...
                            <div class="header-slider-item">
                                <img src="https://clickbuy.com.vn/uploads/2023/05/Flip4.Fold4_.png" width="800px" alt="Slider Image" />
                                <div class="header-slider-caption">
                                    <p>Some text goes here that describes the image</p>
                                    <a class="btn" href=""><i class="fa fa-shopping-cart"></i>Shop Now</a>
                                </div>
                            ...
                            <div class="header-slider-item">
                                <img src="https://clickbuy.com.vn/uploads/2023/04/slide-chao-he-2023-quay-vong-quay-trung-thuong-01-1.png" width="800px" alt="Slider Image" />
                                <div class="header-slider-caption">
                                    <p>Some text goes here that describes the image</p>
                                    <a class="btn" href=""><i class="fa fa-shopping-cart"></i>Shop Now</a>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="review-slider-item">
                                <div class="review-img">
                                    <img src="${dt.anh}" alt="Image">
                                </div>
                                <div class="review-text">
                                    <h2>${dt.tenDienThoai}</h2>
                                    <h3>Profession</h3>
                                    <div class="ratting">
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                    ...
                                    <p>
                                        ${dt.tenDienThoai} ${dt.ram}G ${dt.dungLuong}GB
                                    </p>
                                </div>
                            </div>
                        </div>
