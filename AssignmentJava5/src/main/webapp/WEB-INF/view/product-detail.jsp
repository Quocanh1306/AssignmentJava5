                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="product-detail.jsp" class="nav-item nav-link active">Product Detail</a>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-7">
                                    <div class="product-content">
                                        <div class="title"><h2>${dt.tenDienThoai}</h2></div>
                                        <div class="ratting">
                                        ...
                                        <div class="price">
                                            <h4>Price:</h4>
                                            <c:if test="${not empty dt.getGiaSauKM()}">
                                                <span>${dt.donGia}</span>
                                                <p>${dt.giaSauKM}</p>
                                            </c:if>
                                            <c:if test="${empty dt.getGiaSauKM()}">
                                                <p>${dt.donGia}</p>
                                            </c:if>
                                        ...
                                        <div class="p-color">
                                            <h4>Memory Storage: ${dt.dungLuong}GB</h4>
                                        </div>
                                        <div class="action">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="product-item">
                                            <div class="product-title">
                                                <a href="#">${dt.tenDienThoai} ${dt.ram}G ${dt.dungLuong}GB</a>
                                                <div class="ratting">
                                                    <i class="fa fa-star"></i>
                                                    <i class="fa fa-star"></i>
                                                    <i class="fa fa-star"></i>
